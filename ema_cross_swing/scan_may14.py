"""
Scan all stocks for swing-low-project signals (EMA21/50 touch + uptrend gate)
that fired specifically on 2026-05-14 (yesterday).

Data is read from the sibling ema_scanner/data/{1h,1d}/ folder.
Outputs three sections:
   1d entries on 2026-05-14
   1h entries on 2026-05-14
   stocks present in both
"""
